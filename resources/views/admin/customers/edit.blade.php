    ...
    <div class="col-md-8 offset-md-2">
        ...
        <form action="{{ route('admin.customers.update', $customer) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="customer_number" class="form-control @error('customer_number') is-invalid @enderror" value="{{ old('customer_number', $customer->customer_number) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="tax_id" class="form-control @error('tax_id') is-invalid @enderror" value="{{ old('tax_id', $customer->tax_id) }}">
                @error('tax_id')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="fiscal_address" class="form-control @error('fiscal_address') is-invalid @enderror" rows="3">{{ old('fiscal_address', $customer->fiscal_address) }}</textarea>
